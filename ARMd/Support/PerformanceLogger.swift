...
//  ARMd
//
//  Copied from cisum (Modules/Shared/Utilities). The package carries its own
//  internal copy; this is the app's, per PERFORMANCE_LOGGING_GUIDE.md's
//  "copy to each SDK's Sources directory" pattern.
//
